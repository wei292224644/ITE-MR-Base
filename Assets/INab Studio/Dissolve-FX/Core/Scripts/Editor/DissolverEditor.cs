...
namespace INab.Dissolve
{
    ...
    public class DissolverEditor : Editor
    {
        ...
        SerializedProperty enableInstancedMaterials; //UPDATE: instanced materials
        SerializedProperty renderers; //UPDATE: instanced materials
        SerializedProperty instancedMaterials; //UPDATE: instanced materials
        ...
        void OnEnable()
        {
            ...
            enableInstancedMaterials = serializedObject.FindProperty("enableInstancedMaterials"); 
            instancedMaterials = serializedObject.FindProperty("instancedMaterials"); 
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(enableInstancedMaterials); //UPDATE: instanced materials
            if (enableInstancedMaterials.boolValue)
            {
                EditorGUILayout.PropertyField(renderers);
                GUI.enabled = false;
                EditorGUILayout.PropertyField(instancedMaterials);
                GUI.enabled = true;
            ...
            if (!manualControl.boolValue)
            {
                if (enableInstancedMaterials.boolValue && !Application.isPlaying) GUI.enabled = false;
                ...
                if (enableInstancedMaterials.boolValue && !Application.isPlaying) GUI.enabled = true;
